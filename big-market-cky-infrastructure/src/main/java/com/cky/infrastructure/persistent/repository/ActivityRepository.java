...
import com.cky.domain.activity.event.ActivitySkuStockZeroMessageEvent;
...
public class ActivityRepository implements IActivityRepository {
    ...
    public ActivityAccountDayEntity queryActivityAccountDayByUserId(String userId, Long activityId, String day) {
        ...
        RaffleActivityAccountDay raffleActivityAccountMonthRes=raffleActivityAccountDayDao.queryActivityAccountDayByUserId(raffleActivityAccountDayReq);
        if(raffleActivityAccountMonthRes==null)
            return null;
        return ActivityAccountDayEntity.builder()
                              .userId(raffleActivityAccountMonthRes.getUserId())
                              .activityId(raffleActivityAccountMonthRes.getActivityId())
                              .day(raffleActivityAccountMonthRes.getDay())
                              .dayCount(raffleActivityAccountMonthRes.getDayCount())
                              .dayCountSurplus(raffleActivityAccountMonthRes.getDayCountSurplus())
                              .build();

    }

    /**
     * 查询用户没有使用过的抽奖订单   注意分表 在dao层加上 DBrouter
    ...
    /**
     * 保存聚合对象 在一个事务里 包括更新活动账户 更新日 月 等
    ...
    //前端查询账户信息
    @Override
    public ActivityAccountEntity queryRaffleActivityAccountEntity(String userId, Long activityId) {
        ...
        RaffleActivityAccountMonth raffleActivityAccountMonth = raffleActivityAccountMonthDao.queryActivityAccountMonthByUserId(RaffleActivityAccountMonth.builder().userId(userId)
                .activityId(activityId).build());
        RaffleActivityAccountDay raffleActivityAccountDay = raffleActivityAccountDayDao.queryActivityAccountDayByUserId(RaffleActivityAccountDay.builder().userId(userId)
                .activityId(activityId).build());
        // 组装对象
